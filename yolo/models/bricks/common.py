...
__all__ = [
    "Conv", "DWConv", "DWConvTranspose2d", "TransformerLayer", "TransformerBlock",
    "Bottleneck", "BottleneckCSP", "CrossConv", "C3", "C3x", "C3TR", "C3SPP",
    "C3Ghost", "SPP", "SPPF", "Focus", "GhostConv", "GhostBottleneck", "Contract",
    "Expand", "Concat"
]
...
class BottleneckCSP(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, act=True):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.act = get_activiation(act=act)
